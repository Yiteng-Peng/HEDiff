...
if __name__ == "__main__":
    ...
    Start("credit", "random", "pgd",    seed_num=200, mutation_num=1000, noise_bar = 0.03, iter_bar = 0.01)
    ...
    Start("credit", "margin", "pgd",    seed_num=200, mutation_num=1000, noise_bar = 0.03, iter_bar = 0.01)
    ...
    Start("bank", "random", "pgd",    seed_num=200, mutation_num=1000, noise_bar = 0.03, iter_bar = 0.01)
    ...
    Start("bank", "margin", "pgd",    seed_num=200, mutation_num=1000, noise_bar = 0.03, iter_bar = 0.01)
    ...
    Start("digits", "random", "pgd",    seed_num=200, mutation_num=1000, noise_bar = 0.05, iter_bar = 0.03)
    ...
    Start("digits", "margin", "pgd",    seed_num=200, mutation_num=1000, noise_bar = 0.05, iter_bar = 0.03)
    ...
    Start("mnist", "random", "pgd",    seed_num=200, mutation_num=1000, noise_bar = 0.03, iter_bar = 0.01)
    ...
    Start("mnist", "margin", "pgd",    seed_num=200, mutation_num=1000, noise_bar = 0.03, iter_bar = 0.01)
